...
interface EditCourseFormProps {
  ...
  isCompleted: boolean; // If the course is completed and should not be editable anymore.
}
...
const EditCourseForm = ({
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row sm:justify-between mb-7 gap-2">
